...
public class Customer {
    ...
    public String toCSV() {
        String csvDelimeter = ",";
        return getCustomerNumberAsString() + csvDelimeter + fistName + csvDelimeter + lastName + csvDelimeter + cityName
                + csvDelimeter + getPostalCode() + csvDelimeter + getCreditCardasString();
    }
