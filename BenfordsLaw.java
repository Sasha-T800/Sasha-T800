...
public class BenfordsLaw {
    private static ArrayList<Data> salesDataArray = new ArrayList<Data>();
     ...
     */
    private static void initDataFromCSsvFile() throws FileNotFoundException {
        salesDataArray = new ArrayList<Data>();
        ...
        while (readerFile.hasNext()) // returns a boolean value
        {
            ...
            if (!data.isEmpty()) {
                ...
                if (splitData.length == 2 && Character.isDigit(splitData[1].charAt(0))) {
